  ...
  return (
    <div className='flex flex-col items-start gap-y-3'>
      ...
      <div className='w-full space-y-3'>
        ...
        <div className='form-control'>
          <p className='capitalize'>confirm new password</p>
          <label className='input validator border-base-300/15 dark:border-white/15 bg-amethyst-smoke-300 dark:bg-transparent outline-0'>
            <svg
              className='h-[1em] opacity-50'
              xmlns='http://www.w3.org/2000/svg'
        ...
        {status === 'error' && (
          <p className='alert alert-error alert-soft border-rose-500/5 bg-rose-500/10 dark:bg-rose-500/5 text-rose-600 dark:text-rose-400'>
            {error}
          </p>
        )}
        {status === 'success' && (
          <p className='alert alert-success alert-soft border-emerald-500/5 bg-emerald-500/10 dark:bg-emerald-500/5 text-emerald-600 dark:text-emerald-400'>
