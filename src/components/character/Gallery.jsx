  ...
  return (
    <div id='galleryModal' className='relative'>
      <div className='z-30 fixed top-1/2 left-1/2 transform -translate-1/2 w-full h-screen flex flex-col items-center justify-center gap-3'>
        {/* modal container */}
        <div className='z-50 relative flex flex-col justify-between p-4 max-h-5/6 w-5/6 aspect-3/4 lg:w-4/5 lg:aspect-3/2 box-colors rounded-xl border border-amethyst-smoke-800/40 shadow-2xl'>
          {/* Header with title and image count */}
          <div className='flex items-center justify-between p-1 pb-2 border-b subtle-border-colors'>
            <div className='flex items-center gap-3'>
              <p className='text-xs uppercase tracking-[0.24em] text-amethyst-smoke-950 dark:text-amethyst-smoke-500'>
                Gallery
              </p>
              <h2 className='text-lg font-semibold text-amethyst-smoke-950 dark:text-amethyst-smoke-100'>
                {name || 'Untitled'}
              </h2>
              <span className='text-sm text-amethyst-smoke-950/70 dark:text-amethyst-smoke-400'>
          ...
          <div className='relative flex justify-evenly items-center h-full xs:h-4/5 py-2 w-full'>
            <ChevronLeft
              onClick={onPrev}
          ...
          {windowWidth >= 480 && (
            <div
              id='galleryMap'
              className='flex h-1/6 gap-2 p-1 overflow-x-scroll scrollbar-thin scrollbar-thumb-amethyst-smoke-400/30'
            >
