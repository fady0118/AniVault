      ...
      {!view ? (
        <div id='rating' className='relative'>
          <label className='group peer w-full header-box box-colors-stronger hover:cursor-pointer'>
            ...
            <p className='text-text-light/80 dark:text-text-dark/80 group-hover:text-text-light dark:group-hover:text-text-dark'>
              {heading}
            </p>
            <ChevronDown
              size={14}
                ...
                <div className='flex flex-row items-center gap-x-0.5'>
                  <>
                    {localState === item ? (
                      ...
                      <Square
                        className='stroke-0 fill-amethyst-smoke-200'
                        size={12}
                      />
                    )}
                  </>
                  <p
                    className={`${
                      item.length > 3 ? 'capitalize' : 'uppercase'
                    }`}
                  >
                    {item}
                  </p>
