...
export default function NavLinkBox({ ref, LinkTitle, data }) {
  return (
    <div ref={ref} className="w-70 absolute box-colors-darker border border-dark-amethyst-smoke-50/10 dark:border-amethyst-smoke-50/10 rounded-md linkTarget">
