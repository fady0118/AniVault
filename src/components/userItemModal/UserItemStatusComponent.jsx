      ...
      <section className="rounded-2xl border border-white/10 section-colors-medium p-4 shadow-inner shadow-slate-900/30">
        <div className="flex flex-col gap-4">
          <div className="flex flex-row flex-wrap items-start gap-4">
            <img src={userItemData?.cached_img || jikanData?.images?.webp?.large_image_url || jikanData?.images?.webp?.image_url} className="w-24 h-32 rounded-sm object-cover" alt="" />
            <div className="flex-1 min-w-0">
              <p className="font-bold text-lg truncate">{jikanData?.title || userItemData?.title}</p>
              <span
