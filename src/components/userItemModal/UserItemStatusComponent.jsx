...
const statusEnum = {
  anime: ['unwatched', 'plan_to_watch', 'watching', 'completed', 'dropped'],
...
export default function UserItemStatusComponent ({
  ...
  useEffect(() => {
    ...
    setMangaProgress({
      vols: userItemData?.manga_vols,
      chaps: userItemData?.manga_chaps
    })
  }, [userItemData])
        ...
        <div className='flex flex-col gap-4'>
            ...
            <div className='flex flex-col items-start gap-4 grow'>
              ...
              <div className='grid gap-2.5'>
                ...
                {itemStatus &&
                  ...
                  itemStatus !== 'plan_to_watch' &&
                  itemStatus !== 'unread' &&
                  itemStatus !== 'plan_to_read' && (
                    <div className='grid gap-3'>
                      ...
                      {(itemStatus === 'reading' || itemStatus === 'dropped') &&
                        mediaType === 'manga' && (
          ...
          <div className='flex flex-wrap items-center gap-3'>
            <button
              ...
              className={`w-fit px-8 btn btn-sm btn-outline  capitalize ${
                status !== 'modified'
                  ? 'border-amethyst-smoke-600 text-amethyst-smoke-900/40 dark:text-amethyst-smoke-200/40'
                  : 'border-indigo-600/80 text-indigo-700 dark:text-indigo-300 hover:bg-indigo-500/15 dark:hover:bg-indigo-600/30'
              }`}
            >
              update
            </button>
