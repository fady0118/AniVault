    ...
    <>
      <div className={`relative slide w-full h-full flex justify-end items-center shrink-0 text-6xl `}>
        ...
        <div className={`absolute z-20 top-0 left-0 w-full h-full  ${gradientStyles}`}>
          <div className="sm:w-[65%] h-full flex flex-col justify-end items-start">
            <div className="w-full sm:w-4/5 md:w-2/3 box-border h-1/2 sm:h-2/3 flex flex-col space-y-3 sm:space-y-6 justify-center px-6">
              ...
              <div id="links" className="flex flex-col 2xs:flex-row justify-center items-start 2xs:justify-start 2xs:items-center w-full space-x-5 space-y-3 2xs:space-y-0">
                <div
                  onClick={() => {
                    window.location.pathname = `anime/${animeData.mal_id}`;
                  }}
                ...
                <div
                  onClick={() => {
                    openModal(animeData.trailer.embed_url);
                  }}
        ...
        <img
          className="min-h-screen w-full sm:w-1/2 aspect-auto object-top object-cover pointer-events-none animate-slide"
          src={animeData.images.jpg.large_image_url || animeData.images.webp.large_image_url}
          alt={animeData.title}
        />
      </div>
    </>
