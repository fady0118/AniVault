    ...
    <div className='w-full box-colors-brighter backdrop-blur-md rounded-lg shadow-xl border border-white/20 dark:border-amethyst-smoke-700/30 py-3 sm:py-4 transition-all'>
      ...
      <div className='flex items-center gap-1 px-3 sm:px-4 mb-4'>
        ...
        >
          <ChevronLeft
            size={18}
            className='text-amethyst-smoke-600 dark:text-amethyst-smoke-300 hover:cursor-pointer'
          />
        </button>
        ...
        >
          <ChevronLeft
            size={18}
            className='rotate-180 text-amethyst-smoke-600 dark:text-amethyst-smoke-300 hover:cursor-pointer'
          />
        </button>
      </div>
